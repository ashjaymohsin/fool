#!/usr/bin/env python3
"""Write posts/comments to the correct platform sheet tab (FastFBIApostille sheet)."""
...
SPREADSHEET_ID = "1B_zIL7bdFGKRh1u2MSfXCCx93soGsZS6el7XtJqaeKY"
...
# Others:   Date(0) Title(1) GroupLink(2) Post(3) Comment(4) PostLink(5) CommentLink(6) Notes(7)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python write_sheet_fbi.py '<json>'")
